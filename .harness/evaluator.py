...
VERIFY_CMD: list[str] = ["node", "--check", "app.js"]

# Source directories to search when evaluating.
# All source files live at the project root for this project.
...
def build_ac_section(task: dict) -> str:
    ...
    return textwrap.dedent(
        ...
        2. Find the test(s) that verify it (if applicable — this is a frontend-only project)
...
def build_eval_prompt(plan: dict, task: dict, auto_fix: bool) -> str:
    ...
    return textwrap.dedent(
        ...
        The main source files are `app.js`, `index.html`, and `style.css`.
        ...
        Read the test files if any exist. For each test, ask:
        ...
        Note: This is a vanilla JS project with no test framework. If no tests exist,
        evaluate code correctness through careful code review instead and mark
        test_coverage as N/A.
        ...
        Note: For this vanilla JS project, TDD compliance is relaxed — mark as N/A
        unless a test framework has been added.
        ...
        tdd_compliance: PASS|WARN|FAIL|N/A
        ...
        - OVERALL is FAIL if ANY of: make_check, acceptance_criteria, or
          no_placeholders is FAIL.
        - test_coverage N/A (no test framework) does not cause overall FAIL.
        - tdd_compliance WARN or N/A does not cause overall FAIL but should be noted.
